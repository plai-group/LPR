...
# TODO JASON: Insert RandAugment to the beginning of transforms via
...
class RandAugment:
    # https://github.com/YaqianZhang/RepeatedAugmentedRehearsal/blob/master/run_commands/runs/run_rar_with_der_deraug.sh
    # N: Number of augmentations to sample at once. Default is 1.
    # M: Augmentation strength. Default is 14.
